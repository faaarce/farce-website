...
const HeroSection: FC = () => (
  <div className={`${rule} grid grid-cols-[1fr_1.2fr]`}>
    ...
    <div className={`${colR} pr-6 py-6`}>
      ...
      <h2 className="text-[clamp(32px,5.5vw,64px)] font-extrabold uppercase leading-[0.9] text-[#2a2a2a] mb-1.5 -tracking-[0.02em]">
        SOFTWARE
        <br />
        ENGINEER!
      </h2>
      <div className="w-10 h-[3px] bg-[#2a2a2a] mb-[18px]" />
      ...
      <p className={`${just} text-sm leading-[1.65] text-[#333]`}>
        <span className="float-left text-[58px] font-extrabold leading-[0.75] mr-1.5 mt-1.5 text-[#2a2a2a]">
          A
        </span>
    ...
    <div className="pl-6 py-6">
      <img
        src={IMAGES.portrait}
        alt="Mohammad Faris Arie Prasetyo"
      ...
      {/* Pull quote */}
      <div className="mt-6 py-4 border-t-2 border-t-[#2a2a2a] border-b border-b-[#b5b0a8]">
